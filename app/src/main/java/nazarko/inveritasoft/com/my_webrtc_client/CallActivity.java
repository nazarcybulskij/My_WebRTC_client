package nazarko.inveritasoft.com.my_webrtc_client;
...
//        localProxyRenderer.setTarget(null);
    ...
    private void initData() {
       ...
       // remoteRenderers.add(remoteProxyRenderer);
        ...
        peerConnectionParameters =
                new PeerConnectionClient.PeerConnectionParameters(intent.getBooleanExtra(EXTRA_VIDEO_CALL, true),
        ...
        roomConnectionParameters = new AppRTCClient.RoomConnectionParameters(roomUri.toString(), roomId, urlParameters);
    ...
    private void startCall() {
        ...
        audioManager = AppRTCAudioManager.create(this.getApplicationContext());
